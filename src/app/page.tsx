      ...
      <div className="min-h-screen bg-light-gray relative">
        ...
        <section className="relative bg-white text-dark-gray py-20 overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 p-2 text-gradient">Welcome to the <br/>AI & Emerging Tech Studio</h1>
          ...
          <div className="container max-w-ultra mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 inline-block text-gradient relative">
                Our Solutions
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-primary-light via-primary to-accent-purple rounded-full"></div>
              </h2>
        ...
        <section className="cta-gradient py-16">
          <div className="container mx-auto text-center px-4">
            <h2 className="text-3xl font-bold mb-6 text-gradient">Ready to Explore?</h2>
