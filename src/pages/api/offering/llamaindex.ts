...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (useMockService) {
    const mockResponses = [
      { answer: "This is LlamaIndex speaking. How can I assist you today?" },
      { answer: "LlamaIndex service is ready to help with your queries.", document_path: "/path/to/document/queries.pdf" },
      { answer: "You are now interacting with the LlamaIndex service.", document_path: "/path/to/document/interact.pdf" },
      { answer: "Let me process that through LlamaIndex...", document_path: "/path/to/document/process.pdf" },
      { answer: "LlamaIndex service is here to help you!", document_path: "/path/to/document/help.pdf" },
    ];
