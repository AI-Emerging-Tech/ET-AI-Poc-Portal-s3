...
export default function HeaderWithSession() {
  ...
  // Conditionally hide links if the current page is the login page
  ...
  }, [session, status, isAuthPage, isHomePage]);
  ...
  }, [session, status, router, isPendingApprovalPage, isLoginPage]);
              ...
              {session ? (
                <div className="relative px-1">
                  <button
                    ...
                    className="btn-ai ml-2 relative z-10"
                  >
                    Logout
                  </button>
                </div>
                ...
                <div className="relative px-1">
                  <Link href="/auth/login" className="btn-ai group relative z-10">
                    <span>Login</span>
